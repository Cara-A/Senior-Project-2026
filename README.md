# Senior-Project-2026
Senior Project for PennWest California Senior Project II class, (CMSC-4920-100)
...
Progress
This project will be written using JavaScript, CSS, and HTML. We’ve established our website for documents using a Github repository, the project will be accessible via that same repository 

once it’s complete. We have all necessary developer tools needed to code in JavaScript installed, and we’ve created a basic GUI as a starting point for the project ahead. 
...
Current Challenges: The primary challenge we’re facing right now is that JavaScript has a bit of a learning curve. We decided this project would be a good opportunity to learn another programming language to further expand our skillsets so we’re starting with little prior knowledge of JavaScript, and while it requires a lot of research, we are making progress. In the next few weeks, we would like to continue to build the GUI and work on building the 


algorithms/graphics. Since the visualization component is directly tied to the algorithm’s function, we intend to work on both aspects in tandem.


Leader of the Implementation Phase: Cara Antonucci
